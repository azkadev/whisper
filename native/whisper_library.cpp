...
#include "package/whisper.cpp/examples/common.h" 
#include "package/whisper.cpp/examples/grammar-parser.h"
...
json invokeWhisper(json bodyParameter) {
...
extern "C"
{
    ...
    char* request(char* data) {
        ...
        if (jsonBody["@type"] == "transcribeSync") {
            return jsonToChar(invokeWhisper(jsonBody));
        }

        jsonResult["message"] = "unknown_method";
        return jsonToChar(jsonResult);
    }
